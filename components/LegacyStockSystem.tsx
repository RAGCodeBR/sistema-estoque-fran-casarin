...
declare global {
  interface Window {
    ...
    __estoqueCloudSync?: {
      ...
      deleteCatalog: (tipo: "categoria" | "local" | "bruto" | "fracionado", id: string) => Promise<void>;
...
const assetVersion = `${process.env.NEXT_PUBLIC_APP_VERSION ?? "local"}-exclusao-definitiva-segura-1`;
const defaultEmail = "";
